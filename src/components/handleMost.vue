    ...
    <div class="container">
      <div class="content">
        <div class="head">
          ...
          <span class="text">办理次数最多的事项</span>
        </div>
        <div class="main">
          <div class="imgLogo">
          ...
          <div class="conText">
            <ul v-for="(item,index) in list" :key="index">
              ...
              <li class="dw" :style="aStyle(index)" style="font-size: 10px;margin-top: 6px">条</li>
            </ul>
          </div>
        </div>
...
<style src="../style/common.scss" lang="scss" scoped></style>
